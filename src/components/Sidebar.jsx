...
import S3BucketsNav from "./S3BucketsNav.jsx";
...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
    ...
    return (
        ...
        >
            {/* <!-- SIDEBAR HEADER --> */}
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 -mt-1 lg:py-6.5">
                <NavLink to="/">
                                    ...
                                    return (
                                        <>
                                            ...
                                            >
                                                <BucketIcon/>
                                                S3 Buckets
                                                <DropdownArrow dropdownOpen={open}
